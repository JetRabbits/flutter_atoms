...
class AtomsStrings {
  ...
  static AtomsStrings get current {
    assert(_current != null,
        'No instance of AtomsStrings was loaded. Try to initialize the AtomsStrings delegate before accessing AtomsStrings.current.');
    return _current!;
  }
  ...
  static AtomsStrings of(BuildContext context) {
    ...
    assert(instance != null,
        'No instance of AtomsStrings present in the widget tree. Did you add AtomsStrings.delegate in localizationsDelegates?');
    return instance!;
  }
