import 'package:flutter_atoms/models/json_serializable/stories_entity_details.dart';
...
class StoriesEntity {
  ...
  StoriesEntity({required this.id, required this.title, required this.titleImage, required this.storyItems, required this.details});
